import aiohttp.web, asyncpg, json, aredis, aiokafka, asyncio, builtins, aiohttp_cors, uvloop, math
...
async def database(app):
    ...
    app.setdefault('cache', aredis.StrictRedisCluster(host='redis', port=6379).cache('cache'))
